...
test_that("convert_midi_to_freq maps to appropriate frequencies", {
  expect_equal(convert_midi_to_freq(57, stretched_octave = FALSE), 0.440)
  expect_equal(convert_midi_to_freq(69, stretched_octave = FALSE), 0.880)
  expect_equal(convert_midi_to_freq(c(57, 69), stretched_octave = FALSE), c(0.440, 0.880))
})
